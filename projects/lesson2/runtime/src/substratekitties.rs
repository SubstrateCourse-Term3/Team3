...
#[derive(Encode,Decode,Default,Clone,PartialEql)]
...
decl_event!(
        ...
        <T as balances::Trait>::Balance
    {
        ...
        Transfeered(AccountId,AccountId,Hash),
...
decl_storage! {
    trait Store for Module<T:Trait> as KittyStorage{
        ...
        AllKittiesArry get(kitty_by_index):map u64 => T::Hash;
...
decl_module! {
    pub struct Module<T: Trait> for enum Call where origin : T::Origin {
        ...
        fn create_kitty(origin) -> Result {
            ...
            //<AllKittiesArry<T>>::insert(all_kitties_count,random_hash);
        ...
        fn buy_kitty(origin,kitty_id: T::Hash,max_price: T::Balance) -> Result{
            ...
            ensure!(<Kitties<T>>::exists(kitty_id),"This cat does not exitst");
            ...
            <balance::Module<T> as Currency<_>>::transfer(&sender,&owner,kitty_price)?;
        ...
        fn bread_kitty(origin,kitty_id_1: T::Hash,kitty_id_2: T::Hash) -> Result{
            let sender = ensure_signed(origin)?;
...
impl<T: Trait> Module<T>{
    fn mint(to: T::AccountId,kitty_id: T::Hash,new_kitty:Kitty<T::Hash,T::Balance>) -> Result {
        ...
        <AllKittiesArry<T>>::insert(all_kitties_count,kitty_id);
        <AllKittiesCount<T>>::put(new_all_kitties_count);
    ...
    fn transfer_from(from: T::AccountId,to: T::AccountId,Kitty_id: T::Hash) -> Result {
        ...
        let new_owned_kitty_count_to = owned_kitty_count_to.checked_add(1)
            .ok_or("Transfer cause overflow of 'to' kitty balance")?;

        let new_owned_kitty_count_from = owned_kitty_count_from.checked_sub(1)
            .ok_or("Transfer cause underflow of 'from' kitty balance")?;
